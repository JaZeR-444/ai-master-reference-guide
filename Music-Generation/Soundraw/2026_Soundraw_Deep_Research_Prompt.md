# 2026 Soundraw Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Soundraw.
...
- What Soundraw actually offers today (not aspirationally)
...
- What problem(s) Soundraw is solving
...
Produce a **complete, current list** of all models offered by Soundraw that are accessible via:
- API(s)
...
- Intended Use (as Soundraw positions it; paraphrase precisely and cite source)
...
- Scenarios where Soundraw is a poor choice for a solo builder
...
- When Soundraw is worth investing learning time into
