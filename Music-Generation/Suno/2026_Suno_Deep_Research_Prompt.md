# 2026 Suno Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Suno.
...
- What Suno actually offers today (not aspirationally)
...
- What problem(s) Suno is solving
...
Produce a **complete, current list** of all models offered by Suno that are accessible via:
- API(s)
...
- Intended Use (as Suno positions it; paraphrase precisely and cite source)
...
- Scenarios where Suno is a poor choice for a solo builder
...
- When Suno is worth investing learning time into
