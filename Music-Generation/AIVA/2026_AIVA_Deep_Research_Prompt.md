# 2026 AIVA Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of AIVA.
...
- What AIVA actually offers today (not aspirationally)
...
- What problem(s) AIVA is solving
...
Produce a **complete, current list** of all models offered by AIVA that are accessible via:
- API(s)
...
- Intended Use (as AIVA positions it; paraphrase precisely and cite source)
...
- Scenarios where AIVA is a poor choice for a solo builder
...
- When AIVA is worth investing learning time into
