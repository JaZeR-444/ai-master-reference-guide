# 2026 Amper Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Amper.
...
- What Amper actually offers today (not aspirationally)
...
- What problem(s) Amper is solving
...
Produce a **complete, current list** of all models offered by Amper that are accessible via:
- API(s)
...
- Intended Use (as Amper positions it; paraphrase precisely and cite source)
...
- Scenarios where Amper is a poor choice for a solo builder
...
- When Amper is worth investing learning time into
