# 2026 Leonardo-AI Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Leonardo-AI.
...
- What Leonardo-AI actually offers today (not aspirationally)
...
- What problem(s) Leonardo-AI is solving
...
Produce a **complete, current list** of all models offered by Leonardo-AI that are accessible via:
- API(s)
...
- Intended Use (as Leonardo-AI positions it; paraphrase precisely and cite source)
...
- Scenarios where Leonardo-AI is a poor choice for a solo builder
...
- When Leonardo-AI is worth investing learning time into
