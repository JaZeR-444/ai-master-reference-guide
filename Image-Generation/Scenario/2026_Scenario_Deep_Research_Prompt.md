# 2026 Scenario Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Scenario.
...
- What Scenario actually offers today (not aspirationally)
...
- What problem(s) Scenario is solving
...
Produce a **complete, current list** of all models offered by Scenario that are accessible via:
- API(s)
...
- Intended Use (as Scenario positions it; paraphrase precisely and cite source)
...
- Scenarios where Scenario is a poor choice for a solo builder
...
- When Scenario is worth investing learning time into
