# 2026 Artbreeder Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Artbreeder.
...
- What Artbreeder actually offers today (not aspirationally)
...
- What problem(s) Artbreeder is solving
...
Produce a **complete, current list** of all models offered by Artbreeder that are accessible via:
- API(s)
...
- Intended Use (as Artbreeder positions it; paraphrase precisely and cite source)
...
- Scenarios where Artbreeder is a poor choice for a solo builder
...
- When Artbreeder is worth investing learning time into
