# 2026 RunDiffusion Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of RunDiffusion.
...
- What RunDiffusion actually offers today (not aspirationally)
...
- What problem(s) RunDiffusion is solving
...
Produce a **complete, current list** of all models offered by RunDiffusion that are accessible via:
- API(s)
...
- Intended Use (as RunDiffusion positions it; paraphrase precisely and cite source)
...
- Scenarios where RunDiffusion is a poor choice for a solo builder
...
- When RunDiffusion is worth investing learning time into
