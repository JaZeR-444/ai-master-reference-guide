# 2026 Adobe Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Adobe.
...
- What Adobe actually offers today (not aspirationally)
...
- What problem(s) Adobe is solving
...
Produce a **complete, current list** of all models offered by Adobe that are accessible via:
- API(s)
...
- Intended Use (as Adobe positions it; paraphrase precisely and cite source)
...
- Scenarios where Adobe is a poor choice for a solo builder
...
- When Adobe is worth investing learning time into
