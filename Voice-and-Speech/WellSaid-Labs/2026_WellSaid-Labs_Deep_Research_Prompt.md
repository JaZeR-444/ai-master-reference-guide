# 2026 WellSaid-Labs Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of WellSaid-Labs.
...
- What WellSaid-Labs actually offers today (not aspirationally)
...
- What problem(s) WellSaid-Labs is solving
...
Produce a **complete, current list** of all models offered by WellSaid-Labs that are accessible via:
- API(s)
...
- Intended Use (as WellSaid-Labs positions it; paraphrase precisely and cite source)
...
- Scenarios where WellSaid-Labs is a poor choice for a solo builder
...
- When WellSaid-Labs is worth investing learning time into
