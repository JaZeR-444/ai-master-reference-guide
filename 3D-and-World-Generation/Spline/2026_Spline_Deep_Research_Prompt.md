# 2026 Spline Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Spline.
...
- What Spline actually offers today (not aspirationally)
...
- What problem(s) Spline is solving
...
Produce a **complete, current list** of all models offered by Spline that are accessible via:
- API(s)
...
- Intended Use (as Spline positions it; paraphrase precisely and cite source)
...
- Scenarios where Spline is a poor choice for a solo builder
...
- When Spline is worth investing learning time into
