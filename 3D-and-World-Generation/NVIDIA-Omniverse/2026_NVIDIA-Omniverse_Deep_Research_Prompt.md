# 2026 NVIDIA-Omniverse Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of NVIDIA-Omniverse.
...
- What NVIDIA-Omniverse actually offers today (not aspirationally)
...
- What problem(s) NVIDIA-Omniverse is solving
...
Produce a **complete, current list** of all models offered by NVIDIA-Omniverse that are accessible via:
- API(s)
...
- Intended Use (as NVIDIA-Omniverse positions it; paraphrase precisely and cite source)
...
- Scenarios where NVIDIA-Omniverse is a poor choice for a solo builder
...
- When NVIDIA-Omniverse is worth investing learning time into
