# 2026 Kaedim Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Kaedim.
...
- What Kaedim actually offers today (not aspirationally)
...
- What problem(s) Kaedim is solving
...
Produce a **complete, current list** of all models offered by Kaedim that are accessible via:
- API(s)
...
- Intended Use (as Kaedim positions it; paraphrase precisely and cite source)
...
- Scenarios where Kaedim is a poor choice for a solo builder
...
- When Kaedim is worth investing learning time into
