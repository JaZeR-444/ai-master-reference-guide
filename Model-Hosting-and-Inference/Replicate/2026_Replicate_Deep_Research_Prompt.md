# 2026 Replicate Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Replicate.
...
- What Replicate actually offers today (not aspirationally)
...
- What problem(s) Replicate is solving
...
Produce a **complete, current list** of all models offered by Replicate that are accessible via:
- API(s)
...
- Intended Use (as Replicate positions it; paraphrase precisely and cite source)
...
- Scenarios where Replicate is a poor choice for a solo builder
...
- When Replicate is worth investing learning time into
