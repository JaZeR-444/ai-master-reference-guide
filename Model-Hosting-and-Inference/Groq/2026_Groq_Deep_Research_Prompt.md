# 2026 Groq Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Groq.
...
- What Groq actually offers today (not aspirationally)
...
- What problem(s) Groq is solving
...
Produce a **complete, current list** of all models offered by Groq that are accessible via:
- API(s)
...
- Intended Use (as Groq positions it; paraphrase precisely and cite source)
...
- Scenarios where Groq is a poor choice for a solo builder
...
- When Groq is worth investing learning time into
