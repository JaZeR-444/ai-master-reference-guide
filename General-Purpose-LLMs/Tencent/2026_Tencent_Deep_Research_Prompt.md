# 2026 Tencent Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Tencent.
...
- What Tencent actually offers today (not aspirationally)
...
- What problem(s) Tencent is solving
...
Produce a **complete, current list** of all models offered by Tencent that are accessible via:
- API(s)
...
- Intended Use (as Tencent positions it; paraphrase precisely and cite source)
...
- Scenarios where Tencent is a poor choice for a solo builder
...
- When Tencent is worth investing learning time into
