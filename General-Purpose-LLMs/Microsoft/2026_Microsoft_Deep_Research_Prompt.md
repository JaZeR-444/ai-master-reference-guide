# 2026 Microsoft Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Microsoft.
...
- What Microsoft actually offers today (not aspirationally)
...
- What problem(s) Microsoft is solving
...
Produce a **complete, current list** of all models offered by Microsoft that are accessible via:
- API(s)
...
- Intended Use (as Microsoft positions it; paraphrase precisely and cite source)
...
- Scenarios where Microsoft is a poor choice for a solo builder
...
- When Microsoft is worth investing learning time into
