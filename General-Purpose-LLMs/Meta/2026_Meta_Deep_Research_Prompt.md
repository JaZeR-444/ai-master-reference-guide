# 2026 Meta Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Meta.
...
- What Meta actually offers today (not aspirationally)
...
- What problem(s) Meta is solving
...
Produce a **complete, current list** of all models offered by Meta that are accessible via:
- API(s)
...
- Intended Use (as Meta positions it; paraphrase precisely and cite source)
...
- Scenarios where Meta is a poor choice for a solo builder
...
- When Meta is worth investing learning time into
