# 2026 Yandex Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Yandex.
...
- What Yandex actually offers today (not aspirationally)
...
- What problem(s) Yandex is solving
...
Produce a **complete, current list** of all models offered by Yandex that are accessible via:
- API(s)
...
- Intended Use (as Yandex positions it; paraphrase precisely and cite source)
...
- Scenarios where Yandex is a poor choice for a solo builder
...
- When Yandex is worth investing learning time into
