# 2026 Anthropic Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Anthropic.
...
- What Anthropic actually offers today (not aspirationally)
...
- What problem(s) Anthropic is solving
...
Produce a **complete, current list** of all models offered by Anthropic that are accessible via:
- API(s)
...
- Intended Use (as Anthropic positions it; paraphrase precisely and cite source)
...
- Scenarios where Anthropic is a poor choice for a solo builder
...
- When Anthropic is worth investing learning time into
