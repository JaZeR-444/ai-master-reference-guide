# 2026 xAI Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of xAI.
...
- What xAI actually offers today (not aspirationally)
...
Produce a **complete, current list** of all models offered by xAI that are accessible via:
- API(s)
...
- Intended Use (as xAI positions it; paraphrase precisely and cite source)
...
- Scenarios where xAI is a poor choice for a solo builder
...
- When xAI is worth investing learning time into
