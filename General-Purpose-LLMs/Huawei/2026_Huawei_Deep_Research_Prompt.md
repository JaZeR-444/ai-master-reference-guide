# 2026 Huawei Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Huawei.
...
- What Huawei actually offers today (not aspirationally)
...
- What problem(s) Huawei is solving
...
Produce a **complete, current list** of all models offered by Huawei that are accessible via:
- API(s)
...
- Intended Use (as Huawei positions it; paraphrase precisely and cite source)
...
- Scenarios where Huawei is a poor choice for a solo builder
...
- When Huawei is worth investing learning time into
