# 2026 DeepSeek Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of DeepSeek.
...
- What DeepSeek actually offers today (not aspirationally)
...
- What problem(s) DeepSeek is solving
...
Produce a **complete, current list** of all models offered by DeepSeek that are accessible via:
- API(s)
...
- Intended Use (as DeepSeek positions it; paraphrase precisely and cite source)
...
- Scenarios where DeepSeek is a poor choice for a solo builder
...
- When DeepSeek is worth investing learning time into
