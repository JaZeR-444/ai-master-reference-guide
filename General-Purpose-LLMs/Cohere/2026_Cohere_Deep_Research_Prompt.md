# 2026 Cohere Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Cohere.
...
- What Cohere actually offers today (not aspirationally)
...
- What problem(s) Cohere is solving
...
Produce a **complete, current list** of all models offered by Cohere that are accessible via:
- API(s)
...
- Intended Use (as Cohere positions it; paraphrase precisely and cite source)
...
- Scenarios where Cohere is a poor choice for a solo builder
...
- When Cohere is worth investing learning time into
