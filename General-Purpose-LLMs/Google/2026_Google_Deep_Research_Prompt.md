# 2026 Google Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Google.
...
- What Google actually offers today (not aspirationally)
...
- What problem(s) Google is solving
...
Produce a **complete, current list** of all models offered by Google that are accessible via:
- API(s)
...
- Intended Use (as Google positions it; paraphrase precisely and cite source)
...
- Scenarios where Google is a poor choice for a solo builder
...
- When Google is worth investing learning time into
