# 2026 Luma-AI Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Luma-AI.
...
- What Luma-AI actually offers today (not aspirationally)
...
- What problem(s) Luma-AI is solving
...
Produce a **complete, current list** of all models offered by Luma-AI that are accessible via:
- API(s)
...
- Intended Use (as Luma-AI positions it; paraphrase precisely and cite source)
...
- Scenarios where Luma-AI is a poor choice for a solo builder
...
- When Luma-AI is worth investing learning time into
