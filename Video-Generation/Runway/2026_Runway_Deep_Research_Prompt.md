# 2026 Runway Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Runway.
...
- What Runway actually offers today (not aspirationally)
...
- What problem(s) Runway is solving
...
Produce a **complete, current list** of all models offered by Runway that are accessible via:
- API(s)
...
- Intended Use (as Runway positions it; paraphrase precisely and cite source)
...
- Scenarios where Runway is a poor choice for a solo builder
...
- When Runway is worth investing learning time into
