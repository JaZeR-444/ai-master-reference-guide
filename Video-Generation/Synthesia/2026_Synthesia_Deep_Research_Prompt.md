# 2026 Synthesia Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Synthesia.
...
- What Synthesia actually offers today (not aspirationally)
...
- What problem(s) Synthesia is solving
...
Produce a **complete, current list** of all models offered by Synthesia that are accessible via:
- API(s)
...
- Intended Use (as Synthesia positions it; paraphrase precisely and cite source)
...
- Scenarios where Synthesia is a poor choice for a solo builder
...
- When Synthesia is worth investing learning time into
