# 2026 HeyGen Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of HeyGen.
...
- What HeyGen actually offers today (not aspirationally)
...
- What problem(s) HeyGen is solving
...
Produce a **complete, current list** of all models offered by HeyGen that are accessible via:
- API(s)
...
- Intended Use (as HeyGen positions it; paraphrase precisely and cite source)
...
- Scenarios where HeyGen is a poor choice for a solo builder
...
- When HeyGen is worth investing learning time into
