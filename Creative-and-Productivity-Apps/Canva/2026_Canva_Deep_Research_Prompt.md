# 2026 Canva Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Canva.
...
- What Canva actually offers today (not aspirationally)
...
- What problem(s) Canva is solving
...
Produce a **complete, current list** of all models offered by Canva that are accessible via:
- API(s)
...
- Intended Use (as Canva positions it; paraphrase precisely and cite source)
...
- Scenarios where Canva is a poor choice for a solo builder
...
- When Canva is worth investing learning time into
