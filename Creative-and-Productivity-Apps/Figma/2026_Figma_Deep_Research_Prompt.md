# 2026 Figma Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Figma.
...
- What Figma actually offers today (not aspirationally)
...
- What problem(s) Figma is solving
...
Produce a **complete, current list** of all models offered by Figma that are accessible via:
- API(s)
...
- Intended Use (as Figma positions it; paraphrase precisely and cite source)
...
- Scenarios where Figma is a poor choice for a solo builder
...
- When Figma is worth investing learning time into
