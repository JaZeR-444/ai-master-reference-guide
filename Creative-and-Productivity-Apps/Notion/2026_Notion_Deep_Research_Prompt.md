# 2026 Notion Deep Research Prompt

You are a senior AI research analyst conducting a **foundational, source-driven deep research review** of Notion.
...
- What Notion actually offers today (not aspirationally)
...
- What problem(s) Notion is solving
...
Produce a **complete, current list** of all models offered by Notion that are accessible via:
- API(s)
...
- Intended Use (as Notion positions it; paraphrase precisely and cite source)
...
- Scenarios where Notion is a poor choice for a solo builder
...
- When Notion is worth investing learning time into
